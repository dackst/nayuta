...
def copy_text():
    ...
    filelist = tuple(filter(lambda x: '.tbl' in x or '.tbb' in x,
                        os.listdir(src_path)))
    tgt_path = r'ISO/PSP_GAME/USRDIR/text'
    ...
    # packed_list.append(r'ISO/PSP_GAME/USRDIR/pack/global/first.dat')
    # packed_list.append(r'ISO/PSP_GAME/USRDIR/pack/global/global.dat')
    # packed_update(filelist, packed_list)
...
def copy_eboot_misc():
    ...
    shutil.copy(r'misc/title.txt', r'ISO/PSP_GAME/USRDIR/savefile')
